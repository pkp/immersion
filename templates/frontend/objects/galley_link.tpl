...
<a class="{if $isSupplementary}article__btn galley_supplementary{else}article__btn{/if} {$type}{if $restricted} restricted{/if}" href="{url page=$page op="view" path=$parentId|to_array:$galley->getBestGalleyId()}">
